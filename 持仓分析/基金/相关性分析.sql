...
--                 DECODE(SIF.EN_NAV_ADJUSTED_PRE, 0, 0, SIF.EN_NAV_ADJUSTED / SIF.EN_NAV_ADJUSTED_PRE - 1) FUND_DAY_PROFIT_RATIO
...
--                    LEFT JOIN ZHFX.TSTOCKINFOFUND SIF
--                        ON MFD.VC_WIND_CODE = SIF.VC_WIND_CODE
                    ,
                    TD_ADJ
